    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <form method="post"
                    action="{{ Route::currentRouteName() === 'heros.edit' ? route('heros.update', $home->id) : route('heros.store') }}"
                    enctype="multipart/form-data">

                    @if(Route::currentRouteName() === 'heros.edit')
                    @method('PUT')
                    @endif
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <x-back.card type='info' :outline="true" title=''>
                                <x-back.input title='Title' name='title' :value="isset($home) ? $home->title : ''"
                                    input='text' :required="true">
                                </x-back.input>
                                <x-back.input title='Slug' name='slug' :value="isset($home) ? $home->slug : ''"
                                    input='text' :required="true">
                                </x-back.input>
