                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="product card h-100">
                                                    ...
                                                    <div class="thumbnail card-img-top">
                                                       {{--  <img class="product-image"
                                                            src="/public/Image/Product/{{ $product->image }}" /> --}}
                                                             <img class="product-image" src="{{ url('public/Image/Products/' . $product->image) }}">
                                                    </div>
                                                    ...
                                                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                                        <div class=" col text-center"><a class="btn btn-outline-dark mt-auto" href="{{ route('add.to.cart', $product->id) }}">Add to cart</a></div>
                                                       {{--  <p class="btn-holder"><a href="{{ route('add.to.cart', $product->id) }}" class="btn btn-warning btn-block text-center"
                                                                role="button">Add to cart</a> </p> --}}
                                                        <br>
                                                        <div class="row text-center"><a class="btn btn-outline-dark mt-auto" href="{{ route('detailsproducts.show', $product->id) }}">View options</a></div>
